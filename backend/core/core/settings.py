...
# Add the parent of BASE_DIR to sys.path so apps like appointments and gallery are discoverable
import sys
...
# Cloudinary Storage Configuration (Optional, for production image hosting)
